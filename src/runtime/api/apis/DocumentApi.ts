...
export class DocumentApi extends runtime.BaseAPI {
     ...
     */
    async _deleteRaw(requestParameters: DeleteRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<DeleteResponse>> {
     ...
     * Delete Document from Collection
     */
    async _delete(requestParameters: DeleteRequest, initOverrides?: RequestInit): Promise<DeleteResponse> {
     ...
     */
    async updateRaw(requestParameters: UpdateRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<UpdateResponse>> {
        if (requestParameters.collectionName === null || requestParameters.collectionName === undefined) {
     ...
     * Update Document in Collection
     */
    async update(requestParameters: UpdateRequest, initOverrides?: RequestInit): Promise<UpdateResponse> {
