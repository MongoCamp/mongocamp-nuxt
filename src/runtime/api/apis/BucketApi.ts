...
export class BucketApi extends runtime.BaseAPI {
     ...
     * Clear Bucket
     */
    async clearBucketRaw(requestParameters: ClearBucketRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<JsonResultBoolean>> {
     ...
     * Clear Bucket
     */
    async clearBucket(requestParameters: ClearBucketRequest, initOverrides?: RequestInit): Promise<JsonResultBoolean> {
     ...
     * Delete Bucket
     */
    async deleteBucketRaw(requestParameters: DeleteBucketRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<JsonResultBoolean>> {
        if (requestParameters.bucketName === null || requestParameters.bucketName === undefined) {
     ...
     * Delete Bucket
     */
    async deleteBucket(requestParameters: DeleteBucketRequest, initOverrides?: RequestInit): Promise<JsonResultBoolean> {
