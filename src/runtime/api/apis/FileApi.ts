...
export class FileApi extends runtime.BaseAPI {
     ...
     */
    async deleteFileRaw(requestParameters: DeleteFileRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<DeleteResponse>> {
     ...
     * Delete File from Bucket
     */
    async deleteFile(requestParameters: DeleteFileRequest, initOverrides?: RequestInit): Promise<DeleteResponse> {
     ...
     * Files in Bucket
     */
    async findFilesRaw(requestParameters: FindFilesRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<Array<FileInformation>>> {
        if (requestParameters.bucketName === null || requestParameters.bucketName === undefined) {
     ...
     * Files in Bucket
     */
    async findFiles(requestParameters: FindFilesRequest, initOverrides?: RequestInit): Promise<Array<FileInformation>> {
     ...
     * File from Bucket
     */
    async getFileRaw(requestParameters: GetFileRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<Blob>> {
        if (requestParameters.bucketName === null || requestParameters.bucketName === undefined) {
     ...
     * File from Bucket
     */
    async getFile(requestParameters: GetFileRequest, initOverrides?: RequestInit): Promise<Blob> {
     ...
     */
    async getFileInformationRaw(requestParameters: GetFileInformationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<FileInformation>> {
        if (requestParameters.bucketName === null || requestParameters.bucketName === undefined) {
     ...
     * FileInformation from Bucket
     */
    async getFileInformation(requestParameters: GetFileInformationRequest, initOverrides?: RequestInit): Promise<FileInformation> {
     ...
     * Insert File
     */
    async insertFileRaw(requestParameters: InsertFileRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<InsertResponse>> {
        if (requestParameters.bucketName === null || requestParameters.bucketName === undefined) {
     ...
     * Insert File
     */
    async insertFile(requestParameters: InsertFileRequest, initOverrides?: RequestInit): Promise<InsertResponse> {
     ...
     * Files in Bucket
     */
    async listFilesRaw(requestParameters: ListFilesRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<Array<FileInformation>>> {
        if (requestParameters.bucketName === null || requestParameters.bucketName === undefined) {
     ...
     * Files in Bucket
     */
    async listFiles(requestParameters: ListFilesRequest, initOverrides?: RequestInit): Promise<Array<FileInformation>> {
     ...
     */
    async updateFileInformationRaw(requestParameters: UpdateFileInformationOperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<UpdateResponse>> {
        if (requestParameters.bucketName === null || requestParameters.bucketName === undefined) {
     ...
     * Update FileInformation in Bucket
     */
    async updateFileInformation(requestParameters: UpdateFileInformationOperationRequest, initOverrides?: RequestInit): Promise<UpdateResponse> {
