...
export class CollectionApi extends runtime.BaseAPI {
     ...
     */
    async aggregateRaw(requestParameters: AggregateRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<Array<{ [key: string]: string; }>>> {
     ...
     * Aggregate in Collection
     */
    async aggregate(requestParameters: AggregateRequest, initOverrides?: RequestInit): Promise<Array<{ [key: string]: string; }>> {
     ...
     * Clear Collection
     */
    async clearCollectionRaw(requestParameters: ClearCollectionRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<JsonResultBoolean>> {
        if (requestParameters.collectionName === null || requestParameters.collectionName === undefined) {
     ...
     * Clear Collection
     */
    async clearCollection(requestParameters: ClearCollectionRequest, initOverrides?: RequestInit): Promise<JsonResultBoolean> {
     ...
     * Delete Collection
     */
    async deleteCollectionRaw(requestParameters: DeleteCollectionRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<JsonResultBoolean>> {
        if (requestParameters.collectionName === null || requestParameters.collectionName === undefined) {
     ...
     * Delete Collection
     */
    async deleteCollection(requestParameters: DeleteCollectionRequest, initOverrides?: RequestInit): Promise<JsonResultBoolean> {
     ...
     */
    async distinctRaw(requestParameters: DistinctRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<Array<string>>> {
        if (requestParameters.collectionName === null || requestParameters.collectionName === undefined) {
     ...
     * Distinct in Collection
     */
    async distinct(requestParameters: DistinctRequest, initOverrides?: RequestInit): Promise<Array<string>> {
     ...
     * Collection Fields
     */
    async getCollectionFieldsRaw(requestParameters: GetCollectionFieldsRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<Array<string>>> {
        if (requestParameters.collectionName === null || requestParameters.collectionName === undefined) {
     ...
     * Collection Fields
     */
    async getCollectionFields(requestParameters: GetCollectionFieldsRequest, initOverrides?: RequestInit): Promise<Array<string>> {
     ...
     */
    async getCollectionInformationRaw(requestParameters: GetCollectionInformationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<CollectionStatus>> {
        if (requestParameters.collectionName === null || requestParameters.collectionName === undefined) {
     ...
     * Collection Information
     */
    async getCollectionInformation(requestParameters: GetCollectionInformationRequest, initOverrides?: RequestInit): Promise<CollectionStatus> {
     ...
     * Collection Fields
     */
    async getJsonSchemaRaw(requestParameters: GetJsonSchemaRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<JsonSchema>> {
        if (requestParameters.collectionName === null || requestParameters.collectionName === undefined) {
     ...
     * Collection Fields
     */
    async getJsonSchema(requestParameters: GetJsonSchemaRequest, initOverrides?: RequestInit): Promise<JsonSchema> {
     ...
     * Collection Fields
     */
    async getSchemaAnalysisRaw(requestParameters: GetSchemaAnalysisRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<SchemaAnalysis>> {
        if (requestParameters.collectionName === null || requestParameters.collectionName === undefined) {
     ...
     * Collection Fields
     */
    async getSchemaAnalysis(requestParameters: GetSchemaAnalysisRequest, initOverrides?: RequestInit): Promise<SchemaAnalysis> {
     ...
     * List of Collections
     */
    async listCollectionsRaw(initOverrides?: RequestInit): Promise<runtime.ApiResponse<Array<string>>> {
        const queryParameters: any = {};
     ...
     * List of Collections
     */
    async listCollections(initOverrides?: RequestInit): Promise<Array<string>> {
