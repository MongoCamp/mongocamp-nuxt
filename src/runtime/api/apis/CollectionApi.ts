...
export class CollectionApi extends runtime.BaseAPI {
     ...
     * Clear Collection
     */
    async clearCollectionRaw(requestParameters: ClearCollectionRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<JsonValueBoolean>> {
        if (requestParameters.collectionName === null || requestParameters.collectionName === undefined) {
     ...
     * Clear Collection
     */
    async clearCollection(requestParameters: ClearCollectionRequest, initOverrides?: RequestInit): Promise<JsonValueBoolean> {
     ...
     * Delete Collection
     */
    async deleteCollectionRaw(requestParameters: DeleteCollectionRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<JsonValueBoolean>> {
        if (requestParameters.collectionName === null || requestParameters.collectionName === undefined) {
     ...
     * Delete Collection
     */
    async deleteCollection(requestParameters: DeleteCollectionRequest, initOverrides?: RequestInit): Promise<JsonValueBoolean> {
