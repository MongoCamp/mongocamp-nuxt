...
> Array&lt;DatabaseInfo&gt; databaseInfos()
...
import type { DatabaseInfosRequest } from '';
...
async function example() {
  ...
  try {
    const data = await api.databaseInfos();
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
[**Array&lt;DatabaseInfo&gt;**](DatabaseInfo.md)
...
> JsonValueBoolean deleteDatabase(databaseName)
...
import type { DeleteDatabaseRequest } from '';
...
import type { GetDatabaseInfoRequest } from '';
...
async function example() {
  ...
  const body = {
    // string | Name of your Database
    databaseName: databaseName_example,
  } satisfies GetDatabaseInfoRequest;

  try {
    const data = await api.getDatabaseInfo(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { ListDatabasesRequest } from '';
